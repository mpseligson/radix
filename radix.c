 ...
 *
 * The radix.c class implements R0, the first iteration on the parallelized radix sorting algorithm. 
 */
...
/* main produces an input array and sorts it with parallel radix sort using MPI. 
 */
int main(int argc,
  const char * argv[]) {
  MPI_Init(NULL, NULL);
